package com.example.final_project_cs561.Organization.Adapter;
...
import com.example.final_project_cs561.Organization.UserAdapter;
import com.example.final_project_cs561.Organization.showSignature;
import com.example.final_project_cs561.R;

import java.util.ArrayList;

public class ApproveSignUserAdapter  extends RecyclerView.Adapter<ApproveSignUserAdapter.MyViewHolder>{
        private Context context;
        private ArrayList<UserData> userData;
        public ApproveSignUserAdapter(Context context,ArrayList<UserData> userData){
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            holder.llMain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context, showSignature.class);
                    intent.putExtra("userName",userData.getUserName());
                    intent.putExtra("userEmail",userData.getUserEmail());
                    intent.putExtra("signaturePath",userData.getSignaturePath().trim());
